...
var ReactCardFlip = function (props) {
    ...
    var styles = {
        ...
        front: __assign({ WebkitBackfaceVisibility: 'hidden', backfaceVisibility: 'hidden', left: '0', position: isFlipped ? 'absolute' : 'relative', top: '0', transform: flipDirection === 'horizontal' ? frontRotateY : frontRotateX, transformStyle: 'preserve-3d', width: '140px', height: '200px', zIndex: '2', transition: flipSpeedBackToFront + "s" }, front),
        back: __assign({ WebkitBackfaceVisibility: 'hidden', backfaceVisibility: 'hidden', left: '0', position: isFlipped ? 'relative' : 'absolute', transform: flipDirection === 'horizontal' ? backRotateY : backRotateX, transformStyle: 'preserve-3d', top: '0', width: '140px', height: '200px', transition: flipSpeedFrontToBack + "s" }, back)
    };
